...
impl<'a> WorkflowCompiler<'a> {
    ...
    fn compile_step(
        ...
        match step {
            Step::Tool(s) => {
                ...
                let params: HashMap<String, ParamValue> = s
                    .params
                    .iter()
            ...
            Step::Subworkflow(s) => {
                ...
                self.nodes.insert(
                    id.clone(),
                    RuntimeNode::Call(CallNode {
                        id: id.clone(),
                        next_ids: vec![],
                        guards: inherited.to_vec(),
                        call_type: s.call_type.clone(),
    ...
    fn compile_branch(
        ...
        self.nodes.insert(
            back_id.clone(),
            RuntimeNode::BranchBack(BranchBackNode {
                id: back_id.clone(),
                next_ids: vec![],
            }),
        );
    ...
    fn compile_loop(
        ...
        self.nodes.insert(
            ...
            RuntimeNode::Branch(BranchNode {
                ...
                branch_back_id: Some(back_id.clone()),
                mode: BranchMode::Loop,
                loop_until: Some(step.until.clone()),
            }),
        );
    ...
    fn compile_unordered(
        ...
        self.nodes.insert(
            back_id.clone(),
            RuntimeNode::UnorderedBack(UnorderedBackNode {
                id: back_id.clone(),
                next_ids: vec![],
            }),
        );
        ...
        self.nodes.insert(
            node_id.clone(),
            RuntimeNode::Unordered(UnorderedNode {
                id: node_id.clone(),
                next_ids: vec![],
                case_entry_ids,
                back_node_id: Some(back_id.clone()),
            }),
        );
